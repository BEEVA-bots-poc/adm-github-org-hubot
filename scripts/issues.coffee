  ...
  robot.respond /Quiero (.*) issue número (.*)/i, (res) ->
    ...
    if respondUser is "Aceptar"
      res.reply "Vamos a aceptar issue #{numberIssue}"
       github.put "https://api.github.com/repos/#{repo}/contents/CONTRIBUTORS.json", {message: "my commit message", committer: {name: "Julian",email: "julian.perez@beeva.com"},content: "SG9sYSBtdW5kbw",sha: "808069a0070722f7f08e738e42b7f365865e4fe8"}, (issue) ->
